...
#define LOONGSON_MMCCMD_IRQ		(LOONGSON_CPU_IRQ_BASE + 3)
#define LOONGSON_MMCDAT_IRQ		(LOONGSON_CPU_IRQ_BASE + 4)
#define LOONGSON_USB_IRQ        (LOONGSON_CPU_IRQ_BASE + 5)
#define LOONGSON_SND_MOD_IRQ        (LOONGSON_CPU_IRQ_BASE + 6)
#define LOONGSON_SND_I2S_IRQ        (LOONGSON_CPU_IRQ_BASE + 7)
